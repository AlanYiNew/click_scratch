...
Camkes_LinearIPLookup(ADDR1/MASK1 [GW1] OUT1, ADDR2/MASK2 [GW2] OUT2, ...)
...
B<Note:> Lookups and table updates with Camkes_LinearIPLookup are extremely slow; the
RadixIPLookup and DirectIPLookup elements should be preferred in almost all
cases.  See Camkes_IPRouteTable for a performance comparison.  We provide
Camkes_LinearIPLookup nevertheless for its simplicity.
...
Camkes_LinearIPLookup uses a linear search algorithm that may look at every route on
...
local interface, and all others via gateway 18.26.4.1:
  ...
  ... -> GetIPAddress(16) -> rt;
  rt :: Camkes_LinearIPLookup(18.26.4.24/32 0,
                       18.26.4.255/32 0,
                       18.26.4.0/32 0,
                       18.26.4/24 1,
                       0/0 18.26.4.1 1);
